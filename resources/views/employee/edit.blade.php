...
<div class="container-sm mt-5">
    <form action="{{ route('employee.update',['employee' => $employee->id]) }}" method="POST"  method="POST" enctype="multipart/form-data">
    ...
    <div class="p-5 bg-light rounded-3 border col-xl-6">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                ...
                <a href="{{ route('employees.downloadFile', ['employeeId' =>
